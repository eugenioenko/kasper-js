      ...
      if (isComponent) {
        ...
        if ((_a = this.registry[node.name]) == null ? void 0 : _a.lazy) {
          ...
          if (entry.fallback) {
            ...
            if (typeof fallbackInstance.onMount === "function") fallbackInstance.onMount();
            flushSync(() => {
              this.createSiblings(fallbackNodes, element);
              if (typeof fallbackInstance.onRender === "function") fallbackInstance.onRender();
            });
          }
          if (!entry._promise) {
          ...
          entry._promise.then(() => {
            ...
            const componentNodes = entry.nodes;
            instance.$render = () => {
              this.isRendering = true;
              try {
                this.destroy(element);
                ...
                instance.$slots = slots;
                const prevScope2 = this.interpreter.scope;
                ...
                this.interpreter.scope = prevScope2;
              } finally {
                this.isRendering = false;
              }
            };
