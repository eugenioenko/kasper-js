...
class Transpiler {
      ...
      if (node.type === "element") {
        ...
        if (ifAttr) {
          ...
          while (current < nodes.length) {
            ...
            if (next.type === "comment" || next.type === "text" && !((_a = next.value) == null ? void 0 : _a.trim())) {
              current += 1;
              continue;
            }
  ...
  createElement(node, parent) {
    ...
    try {
      ...
      if (e instanceof KasperError && (e.code.startsWith("K003-") || e.code === KErrorCode.RUNTIME_ERROR)) throw e;
