...
class Transpiler {
  ...
  resolveNodes(tag) {
    ...
    const source = entry.template ?? entry.component.template;
    if (!source) {
      entry.nodes = [];
      return entry.nodes;
    }
